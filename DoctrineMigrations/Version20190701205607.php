...
class Version20190701205607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO `state_edge` (`id`,`mail_assigned`,`mail_team`,`mail_admin`,`mail_reporter`,`is_active`,`created_at`,`updated_at`,`oldState`,`newState`,`discr`) VALUES (13,"all","all","all","all",1,"2019-06-12 17:04:56","2019-06-12 17:04:56","staging","discarded","discarding")');
        ...
        $this->addSql('INSERT INTO `state_edge` (`id`,`mail_assigned`,`mail_team`,`mail_admin`,`mail_reporter`,`is_active`,`created_at`,`updated_at`,`oldState`,`newState`,`discr`) VALUES (16,"all","all","all","all",1,"2019-06-12 17:04:56","2019-06-12 17:04:56","undefined","discarded","discarding")');
        ...
        $this->addSql('INSERT INTO `state_edge` (`id`,`mail_assigned`,`mail_team`,`mail_admin`,`mail_reporter`,`is_active`,`created_at`,`updated_at`,`oldState`,`newState`,`discr`) VALUES (31,"all","all","all","all",1,"2019-06-12 17:04:56","2019-06-12 17:04:56","discarded_by_inactivity","open","reopening")');
