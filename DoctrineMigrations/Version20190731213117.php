...
class Version20190731213117 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE incident_decision ADD unattend_state VARCHAR(100) DEFAULT NULL, ADD unsolved_state VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE incident_decision ADD CONSTRAINT FK_7C69DA3B7DC9D7A5 FOREIGN KEY (unattend_state) REFERENCES incident_state (slug)');
        ...
        $this->addSql('CREATE INDEX IDX_7C69DA3B7DC9D7A5 ON incident_decision (unattend_state)');
        ...
        $this->addSql('update incident set unattended_state="discarded-by-unattended", unsolved_state="discarded-by-unsolved"');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE incident_decision DROP unattend_state, DROP unsolved_state');
    }
}
