...
class Version20190406142130 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE incident_state ADD tlp_state VARCHAR(45) DEFAULT NULL, DROP is_opening, DROP is_closing');
        $this->addSql('ALTER TABLE incident_state ADD CONSTRAINT FK_F8A77091B8037C6C FOREIGN KEY (tlp_state) REFERENCES incident_state_action (slug)');
        $this->addSql('CREATE INDEX IDX_F8A77091B8037C6C ON incident_state (tlp_state)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE incident_state ADD is_opening TINYINT(1) NOT NULL, ADD is_closing TINYINT(1) NOT NULL, DROP tlp_state');
    }
}
