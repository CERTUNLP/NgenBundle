...
class Version20181107171409 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `incident_impact` (`slug`, `name`, `description`) VALUES ('undefined', 'Undefined', 'Undefined')");
        $this->addSql("INSERT INTO `incident_urgency` (`slug`, `name`, `description`) VALUES ('undefined', 'Undefined', 'Undefined')");
