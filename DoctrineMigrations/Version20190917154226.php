...
class Version20190917154226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE state_behavior SET slug="on_treatment", name="On Treatment", is_active=1,can_edit=1,can_enrich=1,can_add_history=1,can_comunicate=1,discr="on_treatment" WHERE slug="open"');
