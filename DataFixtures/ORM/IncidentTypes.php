...
class IncidentTypes extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $incident_types = array(
            ...
            array('name' => "Phishing Mail", 'subject' => "Host %s realizando ataques de mail phishing"),
            array('name' => "Phishing Web", 'subject' => "Host %s realizando ataques de web phishing"),
            array('name' => "Open Portmap", 'subject' => "Host %s con servicio Portmap abierto"),
