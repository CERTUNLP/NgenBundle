...
$incident_reports = array(
    array('lang' => 'en', 'type' => 'blacklist', 'slug' => 'blacklist-en',
        'problem' => 'We would like to inform you that we have detected that the <em>host</em> {{incident.address}} under your administration has been detected in blacklists. For more information please view the attached file.',
        'derivated_problem' => 'Emails sent to certain destinations could be filtered if they contain the IP  {{incident.address}}.', 'verification' => 'You can verify the existence of you IP in different blacklists accessing the following site
...
<pre><code>http://whatismyipaddress.com/blacklist-check
    ...
    array('lang' => 'es', 'type' => 'blacklist', 'slug' => 'blacklist-es', 'problem' => 'Nos comunicamos con usted para informarle que hemos detectado que el Host {{incident.address}} el cual esta bajo su administración, ha sido detectado en blacklists, las cuales se encuentran en el archivo adjunto.', 'derivated_problem' => 'Servicios brindados por la IP {{incident.address}} puede verse afectados por la existencia de dicha IP en la blacklist reportada.', 'verification' => 'Puede comprobar la existencia de su IP en diferentes blacklist consultando el sitio
...
<pre><code>http://whatismyipaddress.com/blacklist-check
    ...
    array('lang' => 'en', 'type' => 'botnet', 'slug' => 'botnet-en', 'problem' => 'We would like to inform you that we have detected that the <em>host</em> {{incident.address}} is currently infected with malware and part of a BotNet.', 'derivated_problem' => 'The consequences of the host being infected may vary, we can list the following:
...
<li><p><a href="http://www.linuxjournal.com/magazine/detecting-botnets">http://www.linuxjournal.com/magazine/detecting-botnets</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'botnet', 'slug' => 'botnet-es', 'problem' => 'Nos comunicamos con Ud. para informarle que se detectó que el host {{incident.address}} se encuentra infectado con un malware el cual participa en la formación de una Botnet.', 'derivated_problem' => 'Encontrándose infectado el equipo, existen diversas consecuencias entre las que podemos listas:
...
* Solicitar al que esta publicando los datos que remueva la publicación', 'more_information' => 'Puede chequear adicionalmente: https://haveibeenpwned.com/', 'is_active' => '1', 'created_at' => '2018-05-03 13:30:56', 'updated_at' => '2018-05-03 13:30:56'),
    array('lang' => 'en', 'type' => 'deface', 'slug' => 'deface-en', 'problem' => 'We would like to inform you that we have detected that web page hosted with IP {{incident.address}} has suffered a defacement\'s attack. This is an attack on a website that changes the visual appearance of the site or a webpage performed by an attacker.', 'derivated_problem' => 'The changes in the existing information of the server indicates that the attackers succeeded to obtain restricted privileges on the server. As a result, the server may be exposed to other types of problems, such as:
...
<pre><code>http://{{incident.address}}/
</code></pre>
...
<pre><code>dig &lt;zona&gt;.unlp.edu.ar @{{incident.address}} axfr
</code></pre>
...
<li><p><a href="http://www.sans.org/reading_room/whitepapers/dns/securing-dns-zone-transfer_868">http://www.esdebian.org/wiki/transferencias-zonas-bind9</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'dns_zone_transfer', 'slug' => 'dns_zone_transfer-es', 'problem' => 'Lo contactamos porque hemos detectado que el servidor DNS con IP {{incident.address}}
...
<pre><code>ntpq -c readvar [{{incident.address}}]
ntpdc -n -c monlist [{{incident.address}}]
</code></pre>
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'en', 'type' => 'drupal_remote_code_execution', 'slug' => 'drupal_remote_code_execution-en', 'problem' => 'Hemos detectado que el host {{incident.address}} tiene una version de Drupal insegura. Se trata de una vulnerabilidad que permite ejecutar código remoto arbitrario sin autentificación previa debido a un problema que afecta a múltiples instancias con configuraciones predeterminadas en el núcleo de Drupal versión 6.x 7.x 8.x. .
Se debe actualizar inmediatamente a una versión de Drupal segura.', 'derivated_problem' => 'La vulnerabilidad permite a un atacante efectuar varios vectores de ataque con el fin de tomar el control de un sitio Web Drupal por completo.', 'verification' => 'https://github.com/pimps/CVE-2018-7600 (validar vulnerabilidad)', 'recomendations' => 'Se debe actualizar inmediatamente a una versión de Drupal segura.', 'more_information' => 'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-7600', 'is_active' => '1', 'created_at' => '2018-04-20 12:33:24', 'updated_at' => '2018-04-20 12:33:24'),
    array('lang' => 'es', 'type' => 'drupal_remote_code_execution', 'slug' => 'drupal_remote_code_execution-es', 'problem' => 'Hemos detectado que el host  {{incident.address}} tiene una version de Drupal insegura.
...
<li><p><a href="https://www.openssl.org/news/secadv_20140407.txt">https://www.openssl.org/news/secadv_20140407.txt</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'heartbleed', 'slug' => 'heartbleed-es', 'problem' => 'Se detectó que el servidor {{incident.address}} posiblemente ha sido atacado mediante la
...
* Solicitar al que esta publicando los datos que remueva la publicación', 'more_information' => 'Puede chequear adicionalmente: https://haveibeenpwned.com/', 'is_active' => '1', 'created_at' => '2018-05-03 13:03:39', 'updated_at' => '2018-05-03 13:03:39'),
    array('lang' => 'en', 'type' => 'malware', 'slug' => 'malware-en', 'problem' => 'We would like to inform you that we have been informed that the <em>host</em> {{incident.address}} is currently infected with malware.', 'derivated_problem' => 'Being the host infected, we can list the following consequences:
...
<li><p>Forming part of a BotNet.</p></li>
    ...
    array('lang' => 'es', 'type' => 'malware', 'slug' => 'malware-es', 'problem' => 'Nos comunicamos con Ud. porque porque hemos sido informados que el host {{incident.address}} se encuentra infectado con un malware.', 'derivated_problem' => 'Encontrándose infectado el equipo existen diversas consecuencias, entre las que podemos listar:
...
<pre><code>dig +short test.openresolver.com TXT @{{incident.address}}
</code></pre>
...
<pre><code>http://openresolver.com/?ip={{incident.address}}
</code></pre>
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_dns', 'slug' => 'open_dns-es', 'problem' => 'Lo contactamos porque hemos sido informados que el <strong>host/servidor</strong> {{incident.address}} brinda servicios de DNS de manera insegura. 
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_elasticsearch', 'slug' => 'open_elasticsearch-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio Elasticseach abierto y accesible desde Internet.', 'derivated_problem' => 'Por defecto, este servicio no brinda ningun tipo de autenticación, lo que significa que cualquier entidad podria tener acceso instantaneo a sus datos.', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p>[Dan Farmer on IPMI security issues] (http://fish2.com/ipmi/)</p></li>
    ...
    array('lang' => 'es', 'type' => 'open_isakmp', 'slug' => 'open_isakmp-es', 'problem' => 'Lo contactamos porque hemos sido informados que el dispositivo {{incident.address}} contiene una vulnerabilidad en el procesamiento de paquetes IKEv1.', 'derivated_problem' => 'Esta vulnerabilidad podría permitir a un atacante remoto no autentiado recuperar el contenido de la memoria, lo cual podría conducir a la divulgación de información confidencial.', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p><a href="https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20160916-ikev1">https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20160916-ikev1</a></p></li>
    ...
    array('lang' => 'en', 'type' => 'open_ldap', 'slug' => 'open_ldap-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host</em> {{incident.address}} has the <strong>Lightweight Directory Access Protocol</strong> (LDAP) service, accessible from the Internet.', 'derivated_problem' => 'The <em>host</em> under your administration could be compromising sensitive information.', 'verification' => NULL, 'recomendations' => '<ul>
...
<li><p><a href="https://www.sans.org/reading-room/whitepapers/directories/securely-implementing-ldap-109">Additional information</a>.</p></li>
    ...
    array('lang' => 'es', 'type' => 'open_ldap', 'slug' => 'open_ldap-es', 'problem' => 'Le contactamos porque se nos ha informado que el <em>host</em> con IP {{incident.address}} tiene el servicio LDAP accesible desde Internet.', 'derivated_problem' => 'El <em>host</em> bajo su administración podría llegar a estar brindando información sensible.', 'verification' => NULL, 'recomendations' => '<ul>
...
<li><p><a href="https://www.sans.org/reading-room/whitepapers/directories/securely-implementing-ldap-109">Información adicional</a>.</p></li>
    ...
    array('lang' => 'es', 'type' => 'open_mdns', 'slug' => 'open_mdns-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio mDNS (Multicast DNS) abierto y accesible desde Internet.', 'derivated_problem' => 'El host bajo su administración podría llegar a ser usado en ataques de amplificación para causar ataques de denegación de servicio (DOS, DDOS).', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<div class = "destacated">
<pre><code>telnet {{incident.address}} 11211
stats items
</code></pre>
...
<li><p>http://es.wikipedia.org/wiki/Defacement</p></li>
    ...
    array('lang' => 'es', 'type' => 'open_memcached', 'slug' => 'open_memcached-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host con {{incident.address}} contiene
...
<li><p><a href="https://docs.mongodb.com/manual/core/security-mongodb-configuration/#bind-ip">Security configuration</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_mongodb', 'slug' => 'open_mongodb-es', 'problem' => 'Le contactamos porque se nos ha informado que el <em>host</em> con IP {{incident.address}} tiene una base de datos MongoDB NoSQL accesible sin restricciones desde Internet.', 'derivated_problem' => 'El <em>host</em> bajo su administración podría llegar a estar brindando información sensible, comprometiendo sistemas que corren él.', 'verification' => 'Para testear manualmente la conexión al servicio puede utilizar el comando:
...
<li><p><a href="http://es.wikipedia.org/wiki/SQL_Slammer">http://es.wikipedia.org/wiki/SQL_Slammer</a></p></li>
    ...
    array('lang' => 'en', 'type' => 'open_netbios', 'slug' => 'open_netbios-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host/server</em> {{incident.address}} has the <strong>Network Basic Input/Output System</strong> (NETBIOS) service, accessible from the Internet.', 'derivated_problem' => 'The <em>host</em> under your administration could be used to perform:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_netbios', 'slug' => 'open_netbios-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio NETBIOS abierto desde Internet.', 'derivated_problem' => 'El host bajo su administración podría ser usado para:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'en', 'type' => 'open_ntp_monitor', 'slug' => 'open_ntp_monitor-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host</em> {{incident.address}} is providing insecure <strong>Network Time Protocol</strong> (NTP) service by responding to <a href="https://www.us-cert.gov/ncas/alerts/TA14-013A">NTP monlist</a> commands.', 'derivated_problem' => 'The <em>host</em> under your administration could be used to perform <a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">amplification</a> attacks to third party\'s, like:
...
<pre><code>ntpdc -n -c monlist {{incident.address}}
</code></pre>
...
about how to disable <code>monlist</code>.', 'is_active' => '1', 'created_at' => '2017-12-21 11:57:59', 'updated_at' => '2017-12-21 11:57:59'),
    array('lang' => 'es', 'type' => 'open_ntp_monitor', 'slug' => 'open_ntp_monitor-es', 'problem' => 'Le contactamos porque se nos ha informado que el <em>host</em> con IP {{incident.address}} brinda
...
sobre cómo deshabilitar <code>monlist</code>.', 'is_active' => '1', 'created_at' => '2017-12-21 11:57:54', 'updated_at' => '2017-12-21 11:57:54'),
    array('lang' => 'en', 'type' => 'open_ntp_version', 'slug' => 'open_ntp_version-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host</em>  {{incident.address}} is providing insecure <strong>Network Time Protocol</strong> (NTP) service by responding to <code>NTP readvar</code> commands.', 'derivated_problem' => '<p class="lead">Problemas derivados</p>
...
<code>NTP readvar</code> queries.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:59', 'updated_at' => '2017-12-21 11:57:59'),
    array('lang' => 'es', 'type' => 'open_ntp_version', 'slug' => 'open_ntp_version-es', 'problem' => 'Le contactamos porque se nos ha informado que el <em>host</em> con IP {{incident.address}} brinda
el servicio de NTP de manera insegura. En particular, el servicio estaría
...
las consultas <code>NTP readvar</code>.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:54', 'updated_at' => '2017-12-21 11:57:54'),
    array('lang' => 'en', 'type' => 'open_portmap', 'slug' => 'open_portmap-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host/server</em>  {{incident.address}} has the <strong>Portmap</strong> service, accessible from the Internet.', 'derivated_problem' => 'The <em>host</em> under your administration could be used to perform <a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">amplification</a> attacks to third party\'s, like:
...
<pre><code>rpcinfo -T udp -p {{incident.address}}
</code></pre>
...
<pre><code>showmount -e {{incident.address}}
</code></pre>
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_portmap', 'slug' => 'open_portmap-es', 'problem' => 'Lo contactamos porque hemos sido informados que el <strong>host/servidor</strong> {{incident.address}} brinda el servicio portmap accesible desde Internet.', 'derivated_problem' => 'El <em>host</em> bajo su administración podría llegar a ser usado en ataques de
<a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">amplificación</a>. Esto 
permitiría realizar ataques a terceros de tipo:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_qotd', 'slug' => 'open_qotd-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio QOTD (Quote of the Day) abierto y accesible desde Internet.', 'derivated_problem' => 'El host bajo su administración podría llegar a ser usado en ataques de amplificación para causar ataques de denegación de servicio (DOS, DDOS).', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p><a href="https://www.howtogeek.com/175087/how-to-enable-and-secure-remote-desktop-on-windows/">https://www.howtogeek.com/175087/how-to-enable-and-secure-remote-desktop-on-windows/</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_redis', 'slug' => 'open_redis-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio Redis abierto y accesible desde Internet.', 'derivated_problem' => 'Por defecto, este servicio no brinda ningun tipo de autenticación, lo que significa que cualquier entidad podria tener acceso instantaneo a sus datos.', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p><a href="http://antirez.com/news/96">http://antirez.com/news/96</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_smb', 'slug' => 'open_smb-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} tiene el servicio SMB (Server Message Block) accesible desde Internet.', 'derivated_problem' => 'Este servicio no utiliza encriptación y puede revelar información sensible o el host bajo su administración podría llegar a ser usado para controlar el dispositivo remotamente.', 'verification' => NULL, 'recomendations' => 'Se recomienda:
...
* Establish firewall rules to filter unauthorized queries.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:59', 'updated_at' => '2017-12-21 11:57:59'),
    array('lang' => 'es', 'type' => 'open_snmp', 'slug' => 'open_snmp-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone de un servicio SNMP (UDP 161) abierto a redes ajenas de la UNLP.', 'derivated_problem' => 'El host bajo su administración podría llegar a ser usado en ataques de:
...
<li><p>No usar la comunidad por defecto.</p></li>
    ...
    array('lang' => 'en', 'type' => 'open_ssdp', 'slug' => 'open_ssdp-en', 'problem' => 'We would like to inform you that we have been notified that the <em>host/server</em> {{incident.address}} has the <strong>Simple Service Discovery Protocol</strong> (SSDP) service, accessible from the Internet.', 'derivated_problem' => 'The host under your administration could be used to perform attacks, such as:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_ssdp', 'slug' => 'open_ssdp-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio SSDP (Simple Service Discovery Protocol) abierto y accesible desde Internet.', 'derivated_problem' => 'El host bajo su administración podría llegar a ser usado en ataques de amplificación para causar ataques de denegación de servicio (DOS, DDOS).', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_telnet', 'slug' => 'open_telnet-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} tiene el servicio Telnet accesible desde Internet.', 'derivated_problem' => 'Este servicio no utiliza encriptación y puede revelar información sensible o el host bajo su administración podría llegar a ser usado para controlar el dispositivo remotamente.', 'verification' => NULL, 'recomendations' => 'Se recomienda:
...
<li><p><a href="https://interwork.com/qa-how-to-eliminate-the-security-risks-associated-with-telnet-ftp/">https://interwork.com/qa-how-to-eliminate-the-security-risks-associated-with-telnet-ftp/</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_tftp', 'slug' => 'open_tftp-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} dispone del servicio TFTP (Trivial file transfer Protocol) abierto y accesible desde Internet.', 'derivated_problem' => 'El host bajo su administración podría llegar a ser usado en ataques de amplificación para causar ataques de denegación de servicio (DOS, DDOS).', 'verification' => NULL, 'recomendations' => 'Se recomienda alguna de las siguientes:
...
<li><p><a href="https://www.us-cert.gov/ncas/alerts/TA14-017A">https://www.us-cert.gov/ncas/alerts/TA14-017A</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'open_vnc', 'slug' => 'open_vnc-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} tiene el servicio VNC (Virtual Network Computer/Computing) accesible desde Internet.', 'derivated_problem' => 'Este servicio no utiliza encriptación y puede revelar información sensible o el host bajo su administración podría llegar a ser usado para controlar el dispositivo remotamente.', 'verification' => NULL, 'recomendations' => 'Se recomienda:
...
<li><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566">http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'poodle', 'slug' => 'poodle-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} es
...
<li><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566">http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'rpz_botnet', 'slug' => 'rpz_botnet-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} está realizando consultas de DNS que arrojan coincidencia con nuestra zona RPZ "BOTNET".
...
Esto indica que la misma esté comprometido con algún tipo de malware y quiera conectarse a un servidor C&amp;C para esperar instrucciones a ejecutar (DoS, fuerza bruta, envío de spams, etc.).', 'verification' => NULL, 'recomendations' => 'Se recomienda analizar el host de la red para verificar y solucionar el problema.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:56', 'updated_at' => '2017-12-21 11:57:56'),
    array('lang' => 'es', 'type' => 'rpz_dbl', 'slug' => 'rpz_dbl-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} está realizando consultas de DNS que arrojan coincidencia con nuestra zona RPZ “DBL”.
...
<li><p>Mejorar la infraestructura anti-spam.</p></li>
    ...
    array('lang' => 'es', 'type' => 'rpz_drop', 'slug' => 'rpz_drop-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} está realizando consultas de DNS que arrojan coincidencia con nuestra zona RPZ “DROP”.
...
También verificar tráfico inusual con Wireshark como así también los procesos ejecutándose en el host.', 'recomendations' => 'Se recomienda aislar el host hasta verificar y solucionar el problema.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:56', 'updated_at' => '2017-12-21 11:57:56'),
    array('lang' => 'es', 'type' => 'rpz_malware_aggressive', 'slug' => 'rpz_malware_aggressive-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} está realizando consultas de DNS que arrojan coincidencia con nuestra zona RPZ “MALWARE-AGGRESSIVE”.
...
También verificar tráfico inusual con Wireshark como así también los procesos ejecutándose en el host.', 'recomendations' => 'Se recomienda aislar el host hasta verificar y solucionar el problema.', 'more_information' => NULL, 'is_active' => '1', 'created_at' => '2017-12-21 11:57:56', 'updated_at' => '2017-12-21 11:57:56'),
    array('lang' => 'es', 'type' => 'rpz_malware', 'slug' => 'rpz_malware-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} está realizando consultas de DNS que arrojan coincidencia con nuestra zona RPZ “MALWARE”.
...
<li><p><a href="https://www.owasp.org/index.php/SQL_Injection_Prevention_Cheat_Sheet">SQL Injection Prevention Cheat Sheet</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'sql_injection', 'slug' => 'sql_injection-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} tiene
...
<li><p><a href="https://www.owasp.org/index.php/SQL_Injection_Prevention_Cheat_Sheet">SQL Injection Prevention Cheat Sheet</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'ssl_poodle', 'slug' => 'ssl_poodle-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} es
vulnerable a POODLE.', 'derivated_problem' => 'POODLE es una falla en SSLv3 que permite a un atacante recuperar
información cifrada, ocasionando de esta forma pérdida de confidencialidad.', 'verification' => 'Acceda a la siguiente página para verificar que los servicios que usted
provee en el host son vulnerables a POODLE:
...
<li><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566">http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-3566</a></p></li>
    ...
    array('lang' => 'es', 'type' => 'suspicious_behavior', 'slug' => 'suspicious_behavior-es', 'problem' => 'Lo contactamos porque hemos sido informados que el host/servidor {{incident.address}} se está comportando de manera sospechosa.', 'derivated_problem' => 'esto se puede deber a
