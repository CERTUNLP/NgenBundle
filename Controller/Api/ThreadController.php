...
class ThreadController extends BaseThreadController
{
    ...
    public function newThreadsAction()
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/new.html.twig');
    ...
    public function editThreadCommentableAction(Request $request, $id)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/commentable.html.twig');
    ...
    public function newThreadCommentsAction(Request $request, $id)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comment_new.html.twig');
    ...
    public function getThreadCommentAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comment.html.twig');
    ...
    public function removeThreadCommentAction(Request $request, $id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comment_remove.html.twig');
    ...
    public function editThreadCommentAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comment_edit.html.twig');
    ...
    public function getThreadCommentsAction(Request $request, $id)
    {
        ...
        if (null === $thread) {
            ...
            if (count($errors) > 0) {
                $view = View::create()
                    ...
                    ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/errors.html.twig');
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comments.html.twig');

        // Register a special handler for RSS. Only available on this route.
        if ('rss' === $request->getRequestFormat()) {
            $templatingHandler = function ($handler, $view, $request) {
                $view->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/thread_xml_feed.html.twig');
    ...
    public function getThreadCommentVotesAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/comment_votes.html.twig');
    ...
    public function newThreadCommentVotesAction(Request $request, $id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('CertUnlpNgenBundle:Incident:Frontend/comments/vote_new.html.twig');
