...
class IncidentDecisionController extends ApiController
{
     ...
     * @ParamConverter("domains", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"repository_method" = "findOneInRange", "domains"="address"},isOptional=true)
