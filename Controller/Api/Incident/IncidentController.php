...
class IncidentController extends ApiController
{
     ...
     * @return View
     */
    public function getIncidentSearchIpV4Action(string $type, string $ipv4): View
    {
     ...
     * @return View
     */
    public function getIncidentSearchIpV6Action(string $type, string $ipv6): View
    {
     ...
     * @return View
     */
    public function getIncidentSearchDomainAction(string $type, string $domain): View
    {
