...
class NetworkController extends ApiController
{
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v4": "ip"}})
     */
    public function patchNetworkIpv4ActivateAction(Request $request, Network $network): View
    {
        return $this->activate($request, $network);
    }
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v6": "ip"}})
     */
    public function patchNetworkIpv6ActivateAction(Request $request, Network $network): View
    {
        return $this->activate($request, $network);
    }
     ...
     */
    public function patchNetworkDomainActivateAction(Request $request, Network $network): View
    {
        return $this->activate($request, $network);
    }
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v4": "ip"}})
     */
    public function patchNetworkIpv4DesactivateAction(Request $request, Network $network): View
    {
        return $this->desactivate($request, $network);
    }
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v6": "ip"}})
     */
    public function patchNetworkIpv6DesactivateAction(Request $request, Network $network): View
    {
        return $this->desactivate($request, $network);
    }
     ...
     */
    public function patchNetworkDomainDesactivateAction(Request $request, Network $network): View
    {
        return $this->desactivate($request, $network);
    }
}
