...
class NetworkController extends ApiController
{
     ...
     * @param View $view
     */
    public function __construct(NetworkHandler $handler, ViewHandlerInterface $viewHandler, View $view)
    {
     ...
     *         name="offset",
     *         in="body",
     *         description="Offset from which to start listing networks.",
     *         required=false,
     *         @SWG\Schema(type="\d+")
     *     ),
     *     @SWG\Parameter(
     *         name="limit",
     *         in="body",
     *         description="How many networks to return.",
     *         required=false,
     *         @SWG\Schema(type="\d+")
     *     ),
     *     @SWG\Response(
