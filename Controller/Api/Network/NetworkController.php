...
class NetworkController extends ApiController
{
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v4": "ip"}})
     */
     ...
     * @ParamConverter("network", class="CertUnlp\NgenBundle\Entity\Network\Network", options={"mapping": {"ip_v6": "ip"}})
     */
