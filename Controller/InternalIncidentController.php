...
class InternalIncidentController extends FOSRestController {
     ...
     * 
     */
    public function getInternalAction(Incident $incident) {
        return $incident;
    }
...
//    }
     ...
     * @throws NotFoundHttpException when incident not exist
     */
    public function patchInternalStateAction(Request $request, Incident $incident, IncidentState $state) {
     ...
     */
    public function patchInternalStateWithParamsAction(Request $request, Incident $incident, IncidentState $state) {
        return $this->patchIncidentState($request, $incident, $state);
    }

    public function patchInternalState(Request $request, Incident $incident, IncidentState $state) {
     ...
     * @FOS\QueryParam(name="hostAddress",strict=true ,requirements="[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}", description="The host IP.")
     */
    public function getInternalWithParamsAction(Incident $incident) {
        return $incident;
    }
     ...
     * @throws NotFoundHttpException when incident not exist
     */
    public function patchInternalAction(Request $request, $incident) {
     ...
     * @FOS\QueryParam(name="hostAddress",strict=true ,requirements="[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}", description="The host IP.")
     */
    public function patchInternalWithParamsAction(Request $request, Incident $incident) {

        return $this->patchIncident($request, $incident);
    }

    public function patchInternal(Request $request, $incident) {
        try {
